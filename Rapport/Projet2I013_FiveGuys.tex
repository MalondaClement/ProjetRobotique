...
\item[-] la partie contrôleur fait le lien entre l'affichage et le modèle, le controleur transmet à la vue les données à afficher depuis le modèle et recommunique au modèle les informations issues des interactions avec l'interface,
